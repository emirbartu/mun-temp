...
import 'package:flutter_portfolio/view%20model/getx_controllers/commitee_controller.dart';
import 'package:flutter_portfolio/view/projects/components/title_text.dart';
import 'package:get/get.dart';
import '../../res/constants.dart';
import '../../view model/responsive.dart';
import 'components/commitee_grid.dart';
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          const TitleText(prefix: 'Committees ', title: 'Committees'),
          const SizedBox(
            height: defaultPadding,
          ),
          Expanded(
